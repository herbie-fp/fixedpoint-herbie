...
(define (generate-fixed-point* nbits scale name)
  ...
  (register-ruleset! 'bitwise-commutativity (list 'arithmetic 'bitwise 'simplfy 'fp-safe)
    '((x ,name) (y ,name))
    '((,(fx-name 'commutate-or)    (bor x y)       (bor y x))
      (,(fx-name 'commutate-xor)   (bxor x y)      (bxor y x))
      (,(fx-name 'commutate-and)   (band x y)      (band y x))))

  (register-ruleset! 'bitwise-associativity (list 'arithmetic 'bitwise 'simplfy 'fp-safe)
  ...
  (register-ruleset! 'bitwise-distribute  (list 'arithmetic 'bitwise 'simplify 'fp-safe)
    '((x ,name) (y ,name) (z ,name))
  ...
  (register-ruleset! 'bitwise-eliminate (list 'arithmetic 'bitwise 'simplfy 'fp-safe)
    '((x ,name) (y ,name))
